...
class LiveDataManager:
    ...
    def fetch_live_pois_by_city(self, city_name: str, duration_days: int = 2) -> pd.DataFrame:
        ...
        #  Broad Semantic Seed (Targeting Master Brands explicitly)
        seed_params = {
            "action": "query",
            "list": "search",
        ...
        #  Expanded Geospatial Sweep (Using dynamic search_radius)
        geo_params = {
            "action": "query",
            "list": "geosearch",
        ...
        # Micro-ruins and minor infrastructure blacklist
        noise_blacklist = [
        ...
        for i in range(0, len(all_page_ids), chunk_size):
            ...
            for pid, page in pages_data.items():
                ...
                if title.lower() == city_name.lower():  # -> to avoid getting same city name as recommendation 
                    continue
